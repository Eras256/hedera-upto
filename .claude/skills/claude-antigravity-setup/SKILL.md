...
description: >
  ...
  to use the Google Drive MCP tools.
...
8. Copy `playbooks/continue.md` (given below) into this project, and add
   its two rules to the end of `AGENTS.md` — the file alone does
   nothing, only `AGENTS.md` loads automatically every session.
9. Copy `playbooks/images.md` (given below) into this project, and add
   its two rules to the end of `AGENTS.md` — same pattern as step 8.
10. Copy `playbooks/git.md` (given below) into this project, and add its
    rule to the end of `AGENTS.md` — same pattern as steps 8-9.
11. Copy `playbooks/drive.md` (given below) into this project, and add
    its rule to the end of `AGENTS.md` — same pattern as steps 8-10.
